      ...
      <div class="col-md-12">
         ...
         <div class="box-body">
                <form role="form" method="post" action="">
                    <div class="col-md-10 form-group" id="searchform">

                        <label>Client</label>
                        <input type="text" autocomplete="off" id="client_name" value="">
                        <input type="hidden" id="client_id" value="">
                        <label for="date">From</label>
                        <input id="fromdate" autocomplete="off" name="date" id="fromdate" placeholder="yyyy-mm-dd" type="text" />

                        <label for="date">To</label>
                        <input id="todate" autocomplete="off" name="date" id="todate" placeholder="yyyy-mm-dd" type="text" />
                ...
                <div class="container">
                    ...
                    <div id="clientname_view" class="textcenters" style="display: flex; align-items: center; justify-content: center;  margin-bottom: 15px; margin-top: 15px;  font-size: 150%; font-weight: bold;">
                        <h1><b></b></h1> <br />
