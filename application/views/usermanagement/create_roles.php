          ...
          <form role="form">
                  <div class="box-body"  style="min-height: 300px;">
                    <div class="form-group col-md-6 ">
                      ...
                      <input type="text" class="form-control" autocomplete="off" id="role_name" placeholder="Enter name"  required/>
                    </div>
                    <div class="form-group col-md-6 ">
                      <label for="code">Code</label>
                      <input type="text" class="form-control" autocomplete="off" id="role_code" placeholder="Enter code" required/>
                  
                    </div>
                    <div class="form-group col-md-12 ">
                      <label>Description</label>
                      <textarea class="form-control" id="role_description" autocomplete="off" rows="3" placeholder="enter description"  required></textarea>
                    </div>
                    <div class="form-group col-md-12 ">
