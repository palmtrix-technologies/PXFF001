...
<form role="form" method="post" action=""> 
                ...
                <input type="button" class="btn btn-success" value="Show" id="show" onclick="profit_loss_data();"/>
                </div>
              ...
              <button id="btnPrint" style="float: left;" class="btn btn-success" onclick="PrintPage()"><i class="fa fa-print"></i>Print</button>
                ...
                <div class="box-body">
                  <div class="row">
                  <center><h5 >(PERIOD: <span id="datefrom"></span>  TO <span id="dateto"></span>)</h5></center>

                  <div class="col-md-12" id="salessummary" >
                    <table id="" class="table table-stripped"  style="background:whitesmoke;">

                    <thead >
                    <center><h5 >INCOME  <span id=""></span></h5></center>
                    ...
                    <thead >
                    <center><h5 >EXPENSES <span id=""></span></h5></center>
