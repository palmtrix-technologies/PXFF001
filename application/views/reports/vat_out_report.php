...
<form role="form" method="post" action=""> 
                ...
                <div class="col-md-2 form-group">
                  <input type="text" autocomplete="off" placeholder="JOB ID" id="jobid" name="jobid" class="form-control"/>
                </div>
                <div class="col-md-1 form-group">
                <input type="button" class="btn btn-success" value="Show" id="show" onclick="get_vatoutreport();"/>
                </div>
