...
<form role="form" method="post" action=""> 
                ...
                <input type="button" class="btn btn-success" value="Show" id="show" onclick="get_paymentreport_cashwise();"/>
                </div>
                ...
                <div class="box-body">
                  <div class="row">
                    ...
                    <thead>
                        ...
                        <tbody class="paymentreportcashwise" >
