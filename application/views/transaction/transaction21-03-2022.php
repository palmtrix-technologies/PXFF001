        ...
        <div class="panel-body">
            <section class="content">
                ...
                <div class="col-md-10">
                        ...
                        <div class="box-header with-border">
                            <div class="box-body">
                                ...
                                <div class="form-group col-md-1">
                                    ...
                                    <input maxlength="100" type="text" autocomplete="off" id="quantity" class="form-control " placeholder="quantity" style="width: 54px;" />
                                </div>
                                <div class="form-group col-md-1">
                                    <label class="control-label">UnitPrice</label>
                                    <input maxlength="50" type="text" autocomplete="off" id="unitprice" class="form-control " placeholder="unit price" style="width: 54px;" />
                                </div>
                                <div class="form-group col-md-1">
                                    <label class="control-label">VAT</label>
                                    <input maxlength="100" type="text" id="vat" autocomplete="off" class="form-control" placeholder="vat" style="width: 54px;" />
                                </div>
                                <div class="form-group col-md-1">
                                    <label class="control-label">Currency</label>
                                    <select class="form-control" id="unit_price" name="unit_price" value="--Select Type--" style="width: 55px;">
                                        <option value="bank">--Select Type--</option>
                                        <?php
                 ...
                 <div class="form-group col-md-1">
                                 <label class="control-label">UnitPrice</label>
                                 <input maxlength="100" type="number" autocomplete="off" id="eunitprice" required="required" class="form-control " placeholder="unit price" style="width: 57px;" />
                              </div>
                              <div class="form-group col-md-1">
                                 <label class="control-label">Quantity</label>
                                 <input maxlength="100" type="text" autocomplete="off" id="suppqty" value=" 1" required="required" class="form-control " placeholder="Quantity" style="width: 57px;" />
                              </div>

                              <div class="form-group col-md-1">
                                 <label class="control-label"> SuppVat</label>
                                 <input maxlength="100" type="text" autocomplete="off" id="suppvat" value="0" required="required" class="form-control " placeholder="vat" style="width: 57px;" />
                              </div>     
   ...
   dataType: 'JSON'
    ...
    var conv_factor=myVariable; 
     ...
     //   var conv_factor = parseFloat($("#conv_factor").val());
        ...
        $(".dataadd").append("<tr class='estmt_details'><td class='desc'>" + desc + " </td> <td class='price_val'>" + price1 + "</td> <td class='quanty'>" + quantity + "</td> <td class='subtotalval_data'>" + SubTotal + "</td> <td class='taxval_data'>" + taxvalue + "</td>  <td class='totalval_data'>" + total + "</td> <td class='hidden unittype'>" + unit_val + "</td><td class='hidden convfact'>" + conv_factor + "</td><td class='hidden desc_id'>" + desc_id + "</td><td class='hidden vatPercentage'>" + vatAmount + "</td><td><a class='rmvbutton'><i class='fa fa-trash-o'></i></a></td>  </tr>");
