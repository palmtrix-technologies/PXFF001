                     ...
                     <div class="box-body">
                        <div class="row">
                           ...
                           <div class="form-group col-md-2">
                              ...
                              <input type="date" autocomplete="off" value="<?php echo $supplierpaymentdata[0]->Date;?>" class="form-control" required id="date" name="date" ></input>
                        ...
                        <div class="form-group col-md-2">
                           ...
                           <div class="form-group col-md-2">
                              ...
                              <input maxlength="100" type="text" autocomplete="off" id="amount" required="required" class="form-control" placeholder=""  value=""/>
                           </div>
                              <div class="form-group col-md-2">
                                 <label class="control-label"></label>
