...
<div class="row">
   <div class="col-md-12 " id="step-1">
      <div class="panel panel-primary  " >
         ...
         <div class="panel-body">
          ...
          <div class="form-group col-md-2">
                    ...
                    <input type="hidden" name="id" id="id"  value="<?php echo $jobdata[0]->JobId;?>" />
      ...
      <input class="form-control" autocomplete="off" id="post_date" name="date" placeholder="YYY/MM/DD" type="text" value="<?php echo $today;?>"/>
              </div>
              <div class="form-group col-md-3">
                  <label class="control-label" for="date">Inv Date</label>
      <input class="form-control" autocomplete="off" id="inv_date" name="date" placeholder="YYY/MM/DD" type="text"/>
              </div>
</div>
<div class="row">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input maxlength="100" type="text" autocomplete="off" id="view_supplier_name" required="required" class="form-control" placeholder=" supplier_name" value="">
              ...
              <div class="form-group col-md-3">
                  ...
                  <input maxlength="100" type="text" autocomplete="off" id="invoice" required="required" class="form-control" placeholder=" invoice" value="">
              </div>
              <div class="form-group col-md-3">
                  <label class="control-label" for="date">Invoice</label>
                  <input maxlength="100" type="text" autocomplete="off" id="invoice_id" required="required" class="form-control" placeholder=" invoice" value="">
              </div>
              <div class="form-group col-md-3">
