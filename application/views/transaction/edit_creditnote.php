...
<div class="row">
   <div class="col-md-12 ">
      ...
      <input class="form-control" id="post_date" autocomplete="off" value="<?php  echo $creditdata[0]->PostingDate; ?>" name="date" placeholder="YYY/MM/DD" type="text"/>
              </div>
              <div class="form-group col-md-3">
                  <label class="control-label" for="date">Inv Date</label>
      <input class="form-control" id="inv_date"  autocomplete="off" value="<?php  echo $creditdata[0]->Date; ?>"  name="date" placeholder="YYY/MM/DD" type="text"/>
              </div>
