                  ...
                  <div class="box-header with-border">
                     <div class="box-body">
                        ...
                        <div class="form-group col-md-2">
                              ...
                              <select class="form-control" id="job_id"  required="required" >
                                        <option value="bank">--Select Job--</option>
                                        <?php

                                        foreach ($job as $values) { ?>
                                            <option value="<?php echo $values->JobId;?>"><?php echo $values->Jobcode;?></option>
                                           <!-- echo '<option value="' . $values->JobId . '" id="' . $values->JobId . '">' . $values->Number . '</option>'; -->
                                      <?php  }
                                        ?>
                                    </select>
