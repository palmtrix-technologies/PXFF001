...
<div class="row">
   <div class="col-md-12 " id="step-1">
      ...
      <input class="form-control" id="post_date" autocomplete="off" name="date" placeholder="YYY/MM/DD" type="text" value="<?php echo $today;?>"/>
              </div>
              <div class="form-group col-md-2">
                  <label class="control-label" for="date">Inv Date</label>
      <input class="form-control" id="inv_date" autocomplete="off" name="date" placeholder="YYY/MM/DD" type="text"/>
              </div>
...
?>
                              ...
                              <div class="form-group col-md-1">
                                 ...
                                 <input maxlength="100" autocomplete="off" type="text" id="quantity" required="required" class="form-control" value=" 0" />
                              </div>
