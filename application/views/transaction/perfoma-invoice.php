...
<body >
    ...
    <div class="textcenters" style="display: flex;   margin-bottom: 15px; margin-top: 15px;">
				<h3><strong >Perfoma Invoice <?php echo $invoicedata[0]->Inv;?>  </strong></h3><br />
            </div>
                    ...
                    <div style="margin-left: 8px;">
                             ...
                             <tbody>
                                      ...
                                      foreach($invoice as $key=>$value)
                                      {
                                        ...
                                        <tr id="currencyfilter">
                                            ...
                                            <td style="text-align: centrighter;" data-price="<?=  $value->UnitPrice; ?>" data-qty="<?=  $value->Quantity; ?>" class="currency">
                                             <?php echo $totalval; ?>
                                            </td>
                                        </tr>
                        ...
                        <div style="width: 98%;  padding-left: 53%;"> 
				<table class="table table-bordered tab3 ">
						<tr>
						<td>Subtotal</td>
						<td style="text-align: right;"><?php echo $invoicedata[0]->Total;?></td>	
						</tr>
						<tr>
						<td>Vat Total(15%)</td>
